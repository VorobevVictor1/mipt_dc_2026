...
from app.crud import create_review, get_reviews, get_review, update_review, delete_review
...
def update_existing_review(
    ...
    if db_review is None:
        raise HTTPException(status_code=status.HTTP_404_NOT_FOUND, detail="Отзыв не найден или вы не автор")
    return db_review
